This repository contains the implementation of a terminal text buffer, handling core operations like text writing, advanced editing (insert, line formatting), cursor management, and scrollback history.
